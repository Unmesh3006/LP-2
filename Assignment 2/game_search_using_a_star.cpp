...
// void printPriorityQueue(priority_queue<pair<int, GameState>, vector<pair<int, GameState>>, greater<pair<int, GameState>>> openSet)
// {
//     while (openSet.empty() == false)
//     {
//         cout << openSet.top().first << endl;
//         printGameState(openSet.top().second);
//         cout << endl;
//         openSet.pop();
//     }
// }
